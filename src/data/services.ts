import { BookOpen, Laptop, GraduationCap, Code, Globe, Users, CheckCircle, ChevronRight, Menu, X, Facebook, Twitter, Instagram, Linkedin, Mail, Phone, MapPin, UserPlus, BookMarked, UserCircle2, BrainCircuit, Landmark } from "lucide-react";
